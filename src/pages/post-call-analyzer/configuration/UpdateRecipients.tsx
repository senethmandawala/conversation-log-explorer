  ...
  return (
    <div className="space-y-4">
      <div className="space-y-2">
        <Text className="text-sm font-medium text-gray-900 block font-sans">Recipients Email Address</Text>
        <div className="space-y-2">
          {recipients.length > 0 && (
            <div className="flex flex-wrap gap-2 p-3 bg-gray-50 rounded-lg border border-gray-200 min-h-[60px]">
              {recipients.map((recipient, index) => (
                <Tag
                  ...
                  className="px-3 py-1 flex items-center gap-1 font-sans"
                >
                  {recipient.name}
                </Tag>
              ))}
          ...
          <Input
            ...
            className="font-sans"
          />
          <Text className="text-xs text-gray-500 block font-sans">
