  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ref={ref}
        className={cn(
          "absolute h-8 w-8 rounded-full inline-flex items-center justify-center border border-input bg-background hover:bg-accent hover:text-accent-foreground transition-colors disabled:opacity-50",
